...
const Item = ({
  ...
  return (
    <>
      <div
        className={`relative border-2 grid items-center h-[313px] ${
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between w-28 my-2">
            ...
            <div className="flex items-center gap-1">
              <StarIcon className="icon-style w-5 h-5 md:w-4 md:h-4 text-orange-500" />
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="bg-white/90 blur-effect-theme button-theme px-2 py-1 shadow shadow-sky-500 text-sm text-black"
              onClick={() => {
                onAddToCart();
                onCartToggle();
              }}
        ...
        <div
          className={`flex items-center ${
            ifExists ? "absolute top-15 right-5" : "justify-center"
          }`}
        >
          <img
            src={img}
