...
const FlexContent = ({
  ...
  return (
    <>
      <div
        className={`flex items-center justify-between lg:flex-col lg:justify-center nike-container mt-20 ${
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          >
            <button
              type="button"
              className="button-theme bg-slate-900 text-slate-100 py-1.5"
            >
              {btn}
            </button>
          </a>
          ...
          <img
            ...
            className={`w-auto object-fill transitions-theme ${
              ifExists
                ...
                : "h-72 lg:h-64 md:h-60 sm:h-48 xsm:h-40 "
            }`}
          />
        </div>
      </div>
